...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Mar 2025 pada 08.10
...
INSERT INTO `dosen` (`kode_dos`, `nama_dos`, `alamat_dos`, `nip`) VALUES
(10, 'Suharto', 'Jl. Jombang', NULL),
(11, 'Martono', 'Jl. Kalpataru', NULL),
(12, 'Rahmawati', 'Jl. Jakarta', NULL),
(13, 'Bambang', 'Jl. Bandung', NULL),
(14, 'Nurul', 'Jl. Raya Tidar', NULL),
(15, 'Dosen Baru', 'Alamat Dosen', NULL),
(23, 'Nama Dosen', 'Alamat Dosen', NULL),
(33, 'Nama Dosen', 'Alamat Dosen', NULL),
(95, 'Nama Dosen', 'Alamat Dosen', NULL);
...
('PTI777', 'Sistem Informasi', 2, 3, 95),
...
ALTER TABLE `jurusan`
  ...
  ADD KEY `fk_jurusan_dosen` (`kode_dos`);
...
ALTER TABLE `matakuliah`
  ...
  ADD KEY `fk_matakuliah_dosen` (`kode_dos`);
...
--
ALTER TABLE `jurusan`
  ADD CONSTRAINT `fk_jurusan_dosen` FOREIGN KEY (`kode_dos`) REFERENCES `dosen` (`kode_dos`);

--
-- Ketidakleluasaan untuk tabel `matakuliah`
--
ALTER TABLE `matakuliah`
  ADD CONSTRAINT `fk_matakuliah_dosen` FOREIGN KEY (`kode_dos`) REFERENCES `dosen` (`kode_dos`);
COMMIT;
